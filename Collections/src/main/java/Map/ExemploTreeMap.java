...
public class ExemploTreeMap {
    ...
    public static void main(String[] args) {
        java.util.TreeMap<String, String> treeCapitais = new TreeMap<>();
        ...
        //Retorno a primeira capital no topo da árvore
        ...
        //Retorno a primeira capital no final da árvore, removendo do map
