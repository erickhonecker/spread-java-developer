...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        //Retorna true se todos os elementos possuem a letra M no nome
        ...
        System.out.println("não tem nenhum elemento com a minúscula no nome? " + estudantes.stream().noneMatch((elemento) ->
                elemento.contains("a")));

        //Retorna o primeiro elemento da coleção, se existir exibe no console
        System.out.println("Retorna o primiero elemento da coleção: ");
